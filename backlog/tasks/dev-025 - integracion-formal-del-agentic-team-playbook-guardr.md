...
<!-- SECTION:PLAN:BEGIN -->
1. Redactar docs/AGENTIC_PLAYBOOK.md con el framework metodológico completo.
2. Redactar docs/DISTRIBUTION.md con las modalidades de consumo y distribución.
3. Actualizar README.md y AGENTS.md con enlaces y extractos clave.
4. Pasar la tarea a doing, tildar criterios y cerrar en done.
<!-- SECTION:PLAN:END -->
